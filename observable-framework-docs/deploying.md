---
url: "https://observablehq.com/framework/deploying"
title: "Deploying | Observable Framework"
---

# [Deploying](https://observablehq.com/framework/deploying\#deploying)
...
If you don’t yet have an app ready to deploy, create one by following our [Getting started guide](https://observablehq.com/framework/getting-started).
...
### [Caching](https://observablehq.com/framework/deploying\#caching)
...
This will only cache data loaders that live under `src/data`. You’ll need to edit the paths above if you’ve configured a source root other than `src`, or if the data loaders you want to cache live elsewhere.

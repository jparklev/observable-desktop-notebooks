---
url: "https://observablehq.com/framework/data-loaders"
title: "Data loaders | Observable Framework"
---

1. [Archives](https://observablehq.com/framework/data-loaders#archives)
2. [Routing](https://observablehq.com/framework/data-loaders#routing)
3. [Execution](https://observablehq.com/framework/data-loaders#execution)
4. [Output](https://observablehq.com/framework/data-loaders#output)
5. [Building](https://observablehq.com/framework/data-loaders#building)
6. [Caching](https://observablehq.com/framework/data-loaders#caching)
7. [Errors](https://observablehq.com/framework/data-loaders#errors)

# [Data loaders](https://observablehq.com/framework/data-loaders\#data-loaders)
...
You can use [continuous deployment](https://observablehq.com/framework/deploying) to rebuild data as often as you like, ensuring that data is always up-to-date.
...
Data loaders use [file-based routing](https://observablehq.com/framework/data-loaders#routing), so assuming this shell script is named `quakes.json.sh`, a `quakes.json` file is then generated at build time. You can access this file from the client using [`FileAttachment`](https://observablehq.com/framework/files):

Object {type: "FeatureCollection", metadata: Object, features: Array(188), bbox: Array(6)}

```js
FileAttachment("quakes.json").json()
```

A data loader can transform data to perfectly suit the needs of a dashboard. The JavaScript data loader below uses [D3](https://observablehq.com/framework/lib/d3) to output [CSV](https://observablehq.com/framework/lib/csv) with three columns representing the _magnitude_, _longitude_, and _latitude_ of each earthquake.
...
Now you can display the earthquakes in a map using [Observable Plot](https://observablehq.com/framework/lib/plot):
...
During preview, the preview server automatically runs the data loader the first time its output is needed and [caches](https://observablehq.com/framework/data-loaders#caching) the result; if you edit the data loader, the preview server will automatically run it again and push the new result to the client.

## [Archives](https://observablehq.com/framework/data-loaders\#archives)
...
The ZIP file itself can be also referenced as a whole — for example if the names of the files are not known in advance — with [`file.zip`](https://observablehq.com/framework/lib/zip):
...
Like with any other file, files from generated archives are live in preview (refreshing automatically if the corresponding data loader is edited), and are added to the build only if [statically referenced](https://observablehq.com/framework/files#static-analysis) by `FileAttachment`.

## [Routing](https://observablehq.com/framework/data-loaders\#routing)
...
The **interpreters** [configuration option](https://observablehq.com/framework/config#interpreters) can be used to extend the list of supported extensions.
...
## [Execution](https://observablehq.com/framework/data-loaders\#execution)
...
## [Output](https://observablehq.com/framework/data-loaders\#output)
...
## [Caching](https://observablehq.com/framework/data-loaders\#caching)
...
See [Automated deploys: Caching](https://observablehq.com/framework/deploying#caching) for more on caching during CI.

## [Errors](https://observablehq.com/framework/data-loaders\#errors)

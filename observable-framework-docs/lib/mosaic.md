---
url: "https://observablehq.com/framework/lib/mosaic"
title: "Mosaic vgplot  | Observable Framework"
---

# [Mosaic vgplot](https://observablehq.com/framework/lib/mosaic\#mosaic-vgplot) [Added in 1.3.0](https://github.com/observablehq/framework/releases/tag/v1.3.0 "Added in 1.3.0")

[Mosaic](https://uwdata.github.io/mosaic/) is a system for linking data visualizations, tables, and inputs, leveraging [DuckDB](https://observablehq.com/framework/lib/duckdb) for scalable processing. Mosaic includes an interactive grammar of graphics, [Mosaic vgplot](https://uwdata.github.io/mosaic/vgplot/), built on [Observable Plot](https://observablehq.com/framework/lib/plot). With vgplot, you can interactively visualize and explore millions — even billions — of data points.

The example below shows the pickup and dropoff locations of one million taxi rides in New York City from Jan 1–3, 2010. The dataset is stored in a 8MB [Apache Parquet](https://observablehq.com/framework/lib/arrow#apache-parquet) file, generated with a [data loader](https://observablehq.com/framework/data-loaders).
...
Mosaic vgplot is available by default in Markdown as `vg` and is backed by the default DuckDB client that is configured using [SQL front matter](https://observablehq.com/framework/sql). If you would prefer to initialize Mosaic yourself, you can do something like:

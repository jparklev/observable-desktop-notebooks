---
url: "https://observablehq.com/framework/lib/deckgl"
title: "deck.gl | Observable Framework"
---

# [deck.gl](https://observablehq.com/framework/lib/deckgl\#deck-gl)
...
## [Personal injury road collisions, 2022](https://observablehq.com/framework/lib/deckgl\#personal-injury-road-collisions-2022)

### [106,004 reported collisions on public roads](https://observablehq.com/framework/lib/deckgl\#reported-collisions-on-public-roads)

FewerMore

Data: [Department for Transport](https://www.data.gov.uk/dataset/cb7ae6f0-4be6-4935-9277-47e5ce24a11f/road-safety-data)
...
### [1\. The data](https://observablehq.com/framework/lib/deckgl\#1-the-data)

The accidentology data is loaded as a CSV file, generated by a data loader ( [`dft-road-collisions.csv.sh`](https://github.com/observablehq/framework/blob/main/docs/data/dft-road-collisions.csv.sh)) using DuckDB to produce an extract from the Department for Transport dataset. The country shapes come from a [TopoJSON](https://observablehq.com/framework/lib/topojson) file, which we convert to GeoJSON.
...
### [2\. The layout](https://observablehq.com/framework/lib/deckgl\#2-the-layout)
...
The colors are represented as (red, green, blue) triplets, as expected by deck.gl. The legend is made using [Observable Plot](https://observablehq.com/framework/lib/plot):
...
### [3\. The DeckGL instance](https://observablehq.com/framework/lib/deckgl\#3-the-deck-gl-instance)
...
### [4\. The props](https://observablehq.com/framework/lib/deckgl\#4-the-props)
...
Lastly, the `t` variable controls the height of the extruded hexagons with a [generator](https://observablehq.com/framework/reactivity#generators) (that can be reset with a button input):

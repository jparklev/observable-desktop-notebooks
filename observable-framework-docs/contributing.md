---
url: "https://observablehq.com/framework/contributing"
title: "Contributing | Observable Framework"
---

1. [Releasing](https://observablehq.com/framework/contributing#releasing)

# [Contributing](https://observablehq.com/framework/contributing\#contributing)
...
Lastly visit [http://127.0.0.1:3000](http://127.0.0.1:3000/).
...
## [Releasing](https://observablehq.com/framework/contributing\#releasing)
...
2. Under **Choose a tag**, enter the new version with a `v` _e.g._`v1.2.3`.

---
url: "https://observablehq.com/framework/inputs/table"
title: "Table input | Observable Framework"
---

1. [Options](https://observablehq.com/framework/inputs/table#options)

# [Table input](https://observablehq.com/framework/inputs/table\#table-input)

[API](https://github.com/observablehq/inputs/blob/main/README.md#table) · [Source](https://github.com/observablehq/inputs/blob/main/src/table.js) · The table input displays tabular data. It’s fast: rows are rendered lazily on scroll. It sorts: click a header to sort, and click again to reverse. And it selects: click a checkbox on any row, and the selected rows are exported as a view value. (And for searching, see the [search input](https://observablehq.com/framework/inputs/search).)
...
Array(7) \["species", "island", "culmen\_length\_mm", "culmen\_depth\_mm", "flipper\_length\_mm", "body\_mass\_g", "sex"\]

```js
penguins.columns
```

|  | Penguin Species | Culmen length (mm) | Culmen Depth (mm) | Flipper length (mm) |
| --- | --- | --- | --- | --- |
|  | Adelie | 39.1 | 18.7 | 181 |
|  | Adelie | 39.5 | 17.4 | 186 |
|  | Adelie | 40.3 | 18 | 195 |
|  | Adelie |  |  |  |
|  | Adelie | 36.7 | 19.3 | 193 |
|  | Adelie | 39.3 | 20.6 | 190 |
|  | Adelie | 38.9 | 17.8 | 181 |
|  | Adelie | 39.2 | 19.6 | 195 |
|  | Adelie | 34.1 | 18.1 | 193 |
|  | Adelie | 42 | 20.2 | 190 |
|  | Adelie | 37.8 | 17.1 | 186 |
|  | Adelie | 37.8 | 17.3 | 180 |
|  | Adelie | 41.1 | 17.6 | 182 |
|  | Adelie | 38.6 | 21.2 | 191 |
|  | Adelie | 34.6 | 21.1 | 198 |
|  | Adelie | 36.6 | 17.8 | 185 |
|  | Adelie | 38.7 | 19 | 195 |
|  | Adelie | 42.5 | 20.7 | 197 |
|  | Adelie | 34.4 | 18.4 | 184 |
|  | Adelie | 46 | 21.5 | 194 |
|  | Adelie | 37.8 | 18.3 | 174 |
|  | Adelie | 37.7 | 18.7 | 180 |
|  | Adelie | 35.9 | 19.2 | 189 |
...
|  | species | island | culmen\_length\_mm | culmen\_depth\_mm | flipper\_length\_mm | ▾body\_mass\_g | sex |
| --- | --- | --- | --- | --- | --- | --- | --- |
|  | Gentoo | Biscoe | 49.2 | 15.2 | 221 | 6,300 | MALE |
|  | Gentoo | Biscoe | 59.6 | 17 | 230 | 6,050 | MALE |
|  | Gentoo | Biscoe | 51.1 | 16.3 | 220 | 6,000 | MALE |
|  | Gentoo | Biscoe | 48.8 | 16.2 | 222 | 6,000 | MALE |
|  | Gentoo | Biscoe | 45.2 | 16.4 | 223 | 5,950 | MALE |
|  | Gentoo | Biscoe | 49.8 | 15.9 | 229 | 5,950 | MALE |
|  | Gentoo | Biscoe | 48.4 | 14.6 | 213 | 5,850 | MALE |
|  | Gentoo | Biscoe | 49.3 | 15.7 | 217 | 5,850 | MALE |
|  | Gentoo | Biscoe | 55.1 | 16 | 230 | 5,850 | MALE |
|  | Gentoo | Biscoe | 49.5 | 16.2 | 229 | 5,800 | MALE |
|  | Gentoo | Biscoe | 48.6 | 16 | 230 | 5,800 | MALE |
|  | Gentoo | Biscoe | 50.4 | 15.7 | 222 | 5,750 | MALE |
|  | Gentoo | Biscoe | 50 | 16.3 | 230 | 5,700 | MALE |
|  | Gentoo | Biscoe | 50 | 15.2 | 218 | 5,700 | MALE |
|  | Gentoo | Biscoe | 50.2 | 14.3 | 218 | 5,700 | MALE |
|  | Gentoo | Biscoe | 49.6 | 16 | 225 | 5,700 | MALE |
|  | Gentoo | Biscoe | 49.8 | 16.8 | 230 | 5,700 | MALE |
|  | Gentoo | Biscoe | 47.8 | 15 | 215 | 5,650 | MALE |
|  | Gentoo | Biscoe | 54.3 | 15.7 | 231 | 5,650 | MALE |
|  | Gentoo | Biscoe | 49.5 | 16.1 | 224 | 5,650 | MALE |
|  | Gentoo | Biscoe | 50.8 | 17.3 | 228 | 5,600 | MALE |
|  | Gentoo | Biscoe | 55.9 | 17 | 228 | 5,600 | MALE |
|  | Gentoo | Biscoe | 49 | 16.1 | 216 | 5,550 | MALE |

```js
Inputs.table(penguins, {sort: "body_mass_g", reverse: true})
```

Tables are [view-compatible](https://observablehq.com/framework/reactivity#inputs): using the view function, you can use a table to select rows and refer to them from other cells, say to chart a subset of the data. Click the checkbox on the left edge of a row to select it, and click the checkbox in the header row to clear the selection. You can shift-click to select a range of rows.
...
Array(0) \[columns: Array(7)\]

```js
selection // Try selecting rows above!
```

The _required_ option determines the selection when no items are selected from the table: if it is true (default), the selection contains the full dataset; otherwise, the selection is empty. The _select_ option [Added in 1.10.0](https://github.com/observablehq/framework/releases/tag/v1.10.0 "Added in 1.10.0") disables user selection of rows, hiding the checkboxes in the first column.
...
|  | species | island | culmen\_length\_mm | culmen\_depth\_mm | flipper\_length\_mm | body\_mass\_g | sex |
| --- | --- | --- | --- | --- | --- | --- | --- |
|  | Adelie | Torgersen | 39.1 | 18.7 | 181 | 3,750 | M |
|  | Adelie | Torgersen | 39.5 | 17.4 | 186 | 3,800 | F |
|  | Adelie | Torgersen | 40.3 | 18.0 | 195 | 3,250 | F |
|  | Adelie | Torgersen |  |  |  |  |  |
|  | Adelie | Torgersen | 36.7 | 19.3 | 193 | 3,450 | F |
|  | Adelie | Torgersen | 39.3 | 20.6 | 190 | 3,650 | M |
|  | Adelie | Torgersen | 38.9 | 17.8 | 181 | 3,625 | F |
|  | Adelie | Torgersen | 39.2 | 19.6 | 195 | 4,675 | M |
|  | Adelie | Torgersen | 34.1 | 18.1 | 193 | 3,475 |  |
|  | Adelie | Torgersen | 42.0 | 20.2 | 190 | 4,250 |  |
|  | Adelie | Torgersen | 37.8 | 17.1 | 186 | 3,300 |  |
|  | Adelie | Torgersen | 37.8 | 17.3 | 180 | 3,700 |  |
|  | Adelie | Torgersen | 41.1 | 17.6 | 182 | 3,200 | F |
|  | Adelie | Torgersen | 38.6 | 21.2 | 191 | 3,800 | M |
|  | Adelie | Torgersen | 34.6 | 21.1 | 198 | 4,400 | M |
|  | Adelie | Torgersen | 36.6 | 17.8 | 185 | 3,700 | F |
|  | Adelie | Torgersen | 38.7 | 19.0 | 195 | 3,450 | F |
|  | Adelie | Torgersen | 42.5 | 20.7 | 197 | 4,500 | M |
|  | Adelie | Torgersen | 34.4 | 18.4 | 184 | 3,325 | F |
|  | Adelie | Torgersen | 46.0 | 21.5 | 194 | 4,200 | M |
|  | Adelie | Biscoe | 37.8 | 18.3 | 174 | 3,400 | F |
|  | Adelie | Biscoe | 37.7 | 18.7 | 180 | 3,600 | M |
|  | Adelie | Biscoe | 35.9 | 19.2 | 189 | 3,800 | F |
...
|  | Adelie | Biscoe | 37.7 | 18.7 | 180 | 3,600 | MALE |
|  | Adelie | Biscoe | 35.9 | 19.2 | 189 | 3,800 | FEMALE |
|  | Adelie | Biscoe | 38.2 | 18.1 | 185 | 3,950 | MALE |
|  | Adelie | Biscoe | 38.8 | 17.2 | 180 | 3,800 | MALE |
|  | Adelie | Biscoe | 35.3 | 18.9 | 187 | 3,800 | FEMALE |
|  | Adelie | Biscoe | 40.6 | 18.6 | 183 | 3,550 | MALE |
|  | Adelie | Biscoe | 40.5 | 17.9 | 187 | 3,200 | FEMALE |
|  | Adelie | Biscoe | 37.9 | 18.6 | 172 | 3,150 | FEMALE |
|  | Adelie | Biscoe | 40.5 | 18.9 | 180 | 3,950 | MALE |
|  | Adelie | Dream | 39.5 | 16.7 | 178 | 3,250 | FEMALE |
|  | Adelie | Dream | 37.2 | 18.1 | 178 | 3,900 | MALE |
|  | Adelie | Dream | 39.5 | 17.8 | 188 | 3,300 | FEMALE |
|  | Adelie | Dream | 40.9 | 18.9 | 184 | 3,900 | MALE |
|  | Adelie | Dream | 36.4 | 17 | 195 | 3,325 | FEMALE |
|  | Adelie | Dream | 39.2 | 21.1 | 196 | 4,150 | MALE |
...
Object {species: "Adelie", island: "Torgersen", culmen\_length\_mm: 36.7, culmen\_depth\_mm: 19.3, flipper\_length\_mm: 193, body\_mass\_g: 3450, sex: "FEMALE"}
...
## [Options](https://observablehq.com/framework/inputs/table\#options)
...
- _select_ [Added in 1.10.0](https://github.com/observablehq/framework/releases/tag/v1.10.0 "Added in 1.10.0") \- if true, allows the user to modify the table’s value by selecting rows; defaults to true

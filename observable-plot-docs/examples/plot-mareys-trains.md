---
url: "https://observablehq.com/@observablehq/plot-mareys-trains"
title: "Marey’s trains"
---

# Marey’s trains

A recreation of [E.J. Marey](https://en.wikipedia.org/wiki/Étienne-Jules_Marey)’s graphical train schedule. Stations are positioned to scale so that slope encodes speed. This display also reveals when and where limited service trains are passed by baby bullets . This type of plot is sometimes called a stringline chart. Based on the [D3 implementation](/@d3/mareys-trains).
